  ...
  return (
    <div className="flex flex-wrap px-10 py-20 justify-center lg:items-center" id="about">
      ...
      <div className="mt-5 lg:mt-0">
        <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" className="max-w-sm rounded-lg shadow-2xl" />
      </div>
    </div>
  )
}
