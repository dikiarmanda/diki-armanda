  ...
  return (
    <div className="navbar fixed start-0 top-0 z-50 bg-base-100 lg:px-10">
      <div className="navbar-start">
        ...
        <a href="/" className="btn btn-ghost text-xl">Diki Armanda</a>
      </div>
      ...
      <div className="navbar-end">
        <label className="swap swap-rotate">
          <input type="checkbox" className="theme-controller" value="synthwave" onChange={handleToggle} checked={theme === "light" ? false : true} />
          {/* sun icon */}
